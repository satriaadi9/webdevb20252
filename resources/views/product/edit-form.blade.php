...
@section('content')
    ...
    <form action="{{ route('update_product', $product->id) }}" class="row g-3" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12">
            ...
            <div class="mb-2">
                <img src="{{ $product->image_path ? asset('product_images/' . $product->image_path) : 'https://placehold.co/200x200?text=No+Image' }}" alt="{{ $product->name }}" style="object-fit: cover; height: 200px; width: 200px;" class="img-thumbnail">
            </div>
